...
export const getNotifications = async (
  ...
  try {
    ...
    brokerResult.rows.forEach((broker: any) => {
      notifications.push({
        id: `broker-${broker.id}`,
        source: "Dashboard",
    ...
    profileResult.rows.forEach((item: any) => {
      notifications.push({
        id: `profile-${item.id}`,
        source: "Admin Approval",
        title: "RA Profile Update Approval",
        description: `${item.name} requested profile changes.`,
