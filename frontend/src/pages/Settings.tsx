...
const Settings = () => {
  ...
  {/* 5. Subscription Status Card */}
    <Box sx={{ backgroundColor: "#fff", border: "1px solid #e0e0e0", borderRadius: "12px", padding: { xs: "20px", sm: "28px" }, marginBottom: "24px", width: "100%", maxWidth: "1000px", boxSizing: "border-box" }}>
